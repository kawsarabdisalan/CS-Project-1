...
Next, I checked if I had a complier downloaded onto my mac. To download this complier, type this into your terminal: "xcode-select --install" and you should have instructions to continue downloading it  <br>
...
# Questions
1. What is the recommneded app to use C++? <br> The recommended programming enviornment would be Visual Studio Code. 
2. How do you run programs in C++? <br> First, open a C++ file using the extension .cpp and start off by writing either #include <iostream> or #include <fstream> which will allow your C++ file to be able to created, written in, and read from.
